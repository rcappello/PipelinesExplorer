...
{
    public override CommandConfiguration CommandConfiguration => new("%PipelinesExplorer.Command.SignInMicrosoft.DisplayName%")
    {
    ...
    public override async Task ExecuteCommandAsync(IClientContext context, CancellationToken cancellationToken)
    {
        ...
        catch (Exception ex)
        {
            ...
            await this.Extensibility.Shell().ShowPromptAsync(
                string.Format(System.Globalization.CultureInfo.CurrentCulture, Strings.MicrosoftSignIn_Failed_Format, ex.Message),
                PromptOptions.OK,
